...
{
    public class DriverPersonalInfoResponseModel : CommonResponseModel
    {
        public PIData data { get; set; }
    }
    public class PIData
    {
        public PIDriverData driverData { get; set; }
        public PIDriverDoc driverDoc { get; set; }
        public PIDriverWallet driverWallet { get; set; }
    }
    public class PIDriverWallet
    {
