...
{
    public class DriverDocumentResponseModel : CommonResponseModel
    {
        public DriverDocData data { get; set; }
    }
    ...
    public class DriverDoc
    {
        ...
        public object cardtypeid { get; set; }
        public string isactive { get; set; }
