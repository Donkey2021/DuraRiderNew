...
{
    public class PoliceVerificationResponseModel : CommonResponseModel
    {
        public PoliceVerificationData data { get; set; }
    }
    public class PoliceVerificationData
    {
        public DriverPoliceVerificationData driverData { get; set; }
        public DriverPoliceVerificationDoc driverDoc { get; set; }
        public DriverPoliceVerificationWallet driverWallet { get; set; }
    }
    public class DriverPoliceVerificationWallet
    {
    ...
    public class DriverPoliceVerificationData
    {
        public int id { get; set; }
    ...
    public class DriverPoliceVerificationDoc
    {
        public int id { get; set; }
